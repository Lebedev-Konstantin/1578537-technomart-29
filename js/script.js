...
let feedbackClose = document.querySelector(".popup-feedback .btn-modal-close");
let feedbackForm = document.querySelector(".popup-feedback-form");
let feedbackName = document.querySelector("#popup-feedback-name");
let feedbackEmail = document.querySelector("#popup-feedback-email");
let feedbackMessage = document.querySelector("#popup-feedback-message");
